...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = '<speak>Welcome to Progressive Web Experience 2021. What do you want to do?</speak>';
...
const FavoriteColorIntentHandler = {
    ...
    handle(handlerInput) {
        const favColor = Alexa.getSlotValue(handlerInput.requestEnvelope, 'favColor');

        const speakOutput = `I like ${favColor} too!`;
...
// send trip details to backend system...

        const speakOutput = `Okay, I've got you down for a trip to ${destination} between ${departureDate} and ${returnDate}. Have a nice trip!`;
