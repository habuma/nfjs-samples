...
const FavoriteColorIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `Yes, I like ${favColor}, too!`;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
...
const FavoritePlanetIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'FavoritePlanetIntent';
    },
    handle(handlerInput) {
        const favPlanet = Alexa.getSlotValue(handlerInput.requestEnvelope, 'favPlanet');

        console.log("FAVORITE PLANET: " + favPlanet);

        const speakOutput = `Yes, I would like to visit ${favPlanet}, too!`;
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
...
const ScheduleTripIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `Trip booked to ${destination} between ${departureDate} and ${returnDate}.`;
